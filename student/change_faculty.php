      ...
      <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white" >
        <div class="position-sticky">
          <div class="list-group list-group-flush mx-3 mt-4">
            ...
            <a href="../student/change_faculty.php" class="list-group-item list-group-item-action py-2 ripple  active" aria-current="true">
              ...
              <div class="card body bg-light" style="padding-top: 10px; padding-bottom: 10px; padding-left: 10px; padding-right: 10px;">
                ...
                <?php
                  ...
                  if(isset($_POST['submit'])){
                    ...
                    $query = "UPDATE student_reg SET faculty = '$faculty'
                ...
                <script type="text/javascript">
                  alert("You have Successfully change your faculty.");
                ...
                <h3 style="text-align: center"> Change faculty</h3> <hr>
                <form method="post" action="#">
                  <div class="form-group">
                    <label> Your current Faculty is</label>
                    <input disabled selected type="text" class="form-control" name="faculty" value="<?php echo $row['faculty']; ?>" required />
                  </div>
