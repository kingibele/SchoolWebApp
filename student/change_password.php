...
<!DOCTYPE html>
  <html lang="en">
    ...
    <body style="font-family: Helvetica;">
        ...
        <div class="container">
            <div class="mx-auto alert bg-light col-lg-4 col-sm-8 mt-4" style="border: 1px solid lightgrey;">
                <?php echo "<h2> Welcome, </h2>" . $_SESSION['email']; ?>
                <h4 class="text-center mt-5"> Student Change Password Portal </h4> <hr>
                <form method="post" action="#">                    
                    ...
                    <div class="form-group mt-3">
                        <input type="submit" name="submit" value="Change Password" class="w-100 btn btn-primary">
                    </div>
                </form>
            </div>
        </div>
